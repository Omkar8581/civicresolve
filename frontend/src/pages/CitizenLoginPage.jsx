    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-teal-700 via-teal-600 to-emerald-600 p-6 text-white text-center relative">
          <div className="w-12 h-12 rounded-2xl bg-white/10 backdrop-blur mx-auto flex items-center justify-center mb-2 shadow-inner">
        ...
        <div className="p-6 sm:p-8 space-y-5">
          ...
          <div className="grid grid-cols-2 rounded-xl bg-slate-100 p-1 text-xs font-bold text-slate-600">
            <button
              type="button"
              className="py-2.5 rounded-lg bg-white text-teal-800 shadow-sm text-center"
            >
              Citizen Login
            </button>
            <Link
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs font-medium text-slate-700">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm shadow-md shadow-teal-600/20 transition-all flex items-center justify-center gap-2 mt-2 active:scale-[0.99]"
            >
              {loading ? (
          ...
          <div className="pt-3 border-t border-slate-100">
            <div className="p-3 rounded-xl bg-teal-50/60 border border-teal-200/80 text-xs text-slate-700 space-y-1.5">
              <div className="flex items-center justify-between">
                <span className="font-extrabold text-teal-900 text-[11px] flex items-center gap-1">
                  <Zap className="w-3.5 h-3.5 text-teal-600 fill-current" />
                  <span>DEMO CITIZEN CREDENTIALS</span>
                </span>
                <button
                  type="button"
                  onClick={fillDemoCitizen}
                  className="text-[10px] font-bold text-teal-700 bg-teal-100 hover:bg-teal-200/80 px-2 py-0.5 rounded transition-colors"
                >
                  ⚡ Auto-Fill
                </button>
              </div>
