        ...
        <div className="absolute right-0 mt-2 w-80 sm:w-96 max-w-[90vw] bg-white rounded-2xl shadow-2xl border border-slate-200 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
            ...
            <div className="flex items-center gap-2">
              {unreadCount > 0 && (
                <button
                  ...
                  className="text-[11px] text-teal-300 hover:text-white transition-colors flex items-center gap-1 font-medium hover:underline"
                >
                  ...
                  {!n.read && (
                    <div className="flex flex-col items-center justify-between pl-1">
                      ...
                      <button
                        ...
                        title="Mark as read"
                        className="text-[10px] text-slate-400 hover:text-teal-700 p-1"
                      >
                        <Check className="w-3 h-3" />
                      </button>
                    </div>
          ...
          <div className="p-2.5 bg-slate-50 border-t border-slate-200 text-center">
            <button
              ...
              className="text-[11px] font-bold text-teal-700 hover:text-teal-900 inline-flex items-center gap-1"
            >
