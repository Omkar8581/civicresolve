...
import { ShieldCheck, Heart, ExternalLink, Phone, Mail, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-white font-extrabold text-lg">
              <span className="p-1.5 bg-teal-600 rounded-lg text-white">🏛️</span>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="hover:text-slate-400">Citizen Privacy Policy</a>
            <a href="#" className="hover:text-slate-400">Terms of Grievance Redressal</a>
            <a href="#" className="hover:text-slate-400">RTI Portal</a>
          </div>
        </div>
      </div>
    </footer>
